          ...
          <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: 52, alignItems: 'start' }}>
            ...
            <aside>
              <div style={{ borderRadius: 4, overflow: 'hidden', marginBottom: 20 }}>
                <img src="/images/free-estimate-measure.jpg" alt="Arborist measuring a tree stump and writing a free estimate on-site for a homeowner" style={{ width: '100%', height: 'auto', display: 'block' }} />
              </div>
